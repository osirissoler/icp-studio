...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('../pages/CrosswordPage.vue'),
        meta: { title: 'Crucigrama', description: 'Crea palabras y pistas bíblicas.', icon: 'grid_on' },
      },
      {
        path: 'actividades/identifica-personaje',
        component: () => import('../pages/CharacterActivityPage.vue'),
        meta: { title: 'Identifica el personaje', description: 'Crea rondas de pistas para identificar personajes bíblicos.', icon: 'person_search' },
      },
      {
        path: 'actividades/organiza-frase',
        component: () => import('../pages/OrderPhraseActivityPage.vue'),
        meta: { title: 'Organiza la frase', description: 'Desordena palabras para reconstruir frases bíblicas.', icon: 'reorder' },
      },
      {
        path: 'actividades/completa-frase',
        component: () => import('../pages/CompletePhraseActivityPage.vue'),
        meta: { title: 'Completa la frase', description: 'Crea frases bíblicas con palabras faltantes.', icon: 'edit_note' },
      },
      {
        path: 'actividades/verdadero-falso',
        component: () => import('../pages/TrueFalseActivityPage.vue'),
        meta: { title: 'Verdadero o falso', description: 'Crea afirmaciones bíblicas para responder verdadero o falso.', icon: 'rule' },
      },
      {
        path: 'actividades/quien-dijo-esto',
        component: () => import('../pages/WhoSaidItActivityPage.vue'),
        meta: { title: '¿Quién dijo esto?', description: 'Crea citas bíblicas para identificar quién las dijo.', icon: 'record_voice_over' },
      },
      {
